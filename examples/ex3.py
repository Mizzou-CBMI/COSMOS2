...
workflow = cosmos.start('Example1', 'analysis_output/ex3', restart=True, skip_confirm=True)
...
t = workflow.add_task(cmd, tags=dict(in_files=[('a', 'b', 'in_file')], out_file='out.txt'))
