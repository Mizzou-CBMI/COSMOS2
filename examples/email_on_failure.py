from kosmos import Execution, KosmosApp, Recipe, Input, ExecutionStatus, signal_execution_status_change
import tools
...
if __name__ == '__main__':
    ...
    kosmos_app = KosmosApp('sqlite:///email_on_failure.db', default_drm='local')
    kosmos_app.initdb()
