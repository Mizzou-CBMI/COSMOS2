...
latex_documents = [
    ("index", "Cosmos.tex", "Cosmos Documentation", "Cosmos Manual", "manual"),
]
...
man_pages = [("index", "cosmos", "Cosmos Documentation",)]
...
texinfo_documents = [
    ("index", "Cosmos", "Cosmos Documentation", "Miscellaneous"),
]
